...
for i in {0..10}
    do
        ...
        then
            ...
            python PADChest_eval_rand_seeds.py --root_path=workspace/datasets-$SLURM_JOBID --exp=PADChest_eval_seed_$p1 --seed=$p1 --batch-size=64 --no-visualize --save --workers=8
         fi
    done
