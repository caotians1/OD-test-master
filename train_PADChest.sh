...
python setup/PAD/PADTrain_binary.py --root_path=workspace/datasets-$SLURM_JOBID --exp="PADChestDenseBalancedLateral" --batch-size=64 --no-visualize --save --workers=8